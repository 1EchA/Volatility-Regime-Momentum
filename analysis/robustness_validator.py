...
def main():
    ...
    parser.add_argument(
        "--start-oos", type=str, default="2021-01-01,2022-01-01,2022-07-01"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="hysteresis",
        choices=["baseline", "hysteresis", "combo"],
    )
